  ...
  function RecordsData (value){
    ...
    return (
        ...
        <GridContainer>
          ...
          <CardHeader color="primary">
           <div className="flex flex-row">
             <div> <h4 ><b>Audios</b></h4>
            <p>
              All audios recorded on the machines
            </p>
            </div>
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        ...
        <TableBody>
       {records.recording_data === null || records.recording_data === undefined ? null :   
       records.recording_data.map((val ,key)=>(
        <TableRow key={key}>
              <TableCell component="th" scope="row" align="center">
                {val.id}
              </TableCell>
              <TableCell align="center">{val.created_datetime}</TableCell>
              <TableCell align="center"><ReactAudioPlayer
